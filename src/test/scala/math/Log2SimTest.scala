...
//               println(f"test: test(${zsimsgn}|${zsimexp}(${zsimexp - spec.exBias})|${zsimman.toLong.toBinaryString}(${zsimman.toLong}%x)) != ref(${zrefsgn}|${zrefexp}(${zrefexp - spec.exBias})|${zrefman.toLong.toBinaryString}(${zrefman.toLong}%x))")
  ...
  log2Test(log2FP32TableI, log2FP32SmallPositiveTableI, log2FP32SmallNegativeTableI, RealSpec.Float32Spec, n, r,
    f"Test Small More Than 1 [1+2^-8, 2]",
    generateRealWithin(1.0+pow(2.0, -8), 2.0,_,_), 3)

  log2Test(log2FP32TableI, log2FP32SmallPositiveTableI, log2FP32SmallNegativeTableI, RealSpec.Float32Spec, n, r,
    f"Test Taylor More Than 1 [1, 1+2^-8]",
    generateRealWithin(1.0, 1.0+pow(2.0, -8) - pow(2.0,-RealSpec.Float32Spec.manW),_,_), 3)
  log2Test(log2FP32TableI, log2FP32SmallPositiveTableI, log2FP32SmallNegativeTableI, RealSpec.Float32Spec, n, r,
    f"Test Taylor More Than 1 [1-2^-8, 1]",
    generateRealWithin(1.0-pow(2.0, -8) + pow(2.0,-RealSpec.Float32Spec.manW), 1.0,_,_), 3)
...
//   })
  ...
  log2Test(log2FP32TableI, log2FP32SmallPositiveTableI, log2FP32SmallNegativeTableI, RealSpec.Float32Spec, n, r,
    f"Test Small Less Than 1 [0.5, 1-2^-8]",
    generateRealWithin(0.5,1.0-pow(2.0, -8),_,_), 3)
  log2Test(log2FP32TableI, log2FP32SmallPositiveTableI, log2FP32SmallNegativeTableI, RealSpec.Float32Spec, n, r,
  ...
  log2Test(log2BF16TableI, log2BF16SmallPositiveTableI, log2BF16SmallNegativeTableI, RealSpec.BFloat16Spec, n, r,
    f"Test Small More Than 1 [1+2^-3, 2]",   generateRealWithin(1.0+pow(2.0, -3), 2.0,_,_), 3)

  log2Test(log2BF16TableI, log2BF16SmallPositiveTableI, log2BF16SmallNegativeTableI, RealSpec.BFloat16Spec, n, r,
    f"Test Taylor More Than 1 [1, 1+2^-3]",
    generateRealWithin(1.0, 1.0+pow(2.0, -3) - pow(2.0,-RealSpec.BFloat16Spec.manW),_,_), 3)
  log2Test(log2BF16TableI, log2BF16SmallPositiveTableI, log2BF16SmallNegativeTableI, RealSpec.BFloat16Spec, n, r,
    f"Test Taylor More Than 1 [1-2^-3, 1]",
    generateRealWithin(1.0-pow(2.0, -3) + pow(2.0,-RealSpec.BFloat16Spec.manW), 1.0,_,_), 3)
...
//   })
  ...
  log2Test(log2BF16TableI, log2BF16SmallPositiveTableI, log2BF16SmallNegativeTableI, RealSpec.BFloat16Spec, n, r,
    f"Test Small Less Than 1 [0.5, 1-2^-3]",
    generateRealWithin(0.5,1.0-pow(2.0, -3),_,_), 3)
  log2Test(log2BF16TableI, log2BF16SmallPositiveTableI, log2BF16SmallNegativeTableI, RealSpec.BFloat16Spec, n, r,
    "Test Large Less Than 1 [0, 0.5]", generateRealWithin(0.0,0.5,_,_), 3)
